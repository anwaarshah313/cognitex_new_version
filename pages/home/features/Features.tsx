        ...
        <>
            <div className={style.feature_main}>
                <div className={style.feature_in}>
                    ...
                    <img className={style.feature_img} src="./images/feature.png" alt="" />
                    ...
                    <div className={style.feature_cardDiv}>
                        ...
                        <div className={style.feature_card}>
                            <div className={style.feature_cardIconDiv}> <div className={style.feature_cardIcon}><img src="./images/dollar.svg" alt="" /></div></div>
                        ...
                        <div className={style.feature_card}>
                            <div className={style.feature_cardIconDiv}> <div className={style.feature_cardIcon}><img src="./images/Scalable.svg" alt="" /></div></div>
                        ...
                        <div className={style.feature_card}>
                            <div className={style.feature_cardIconDiv}> <div className={style.feature_cardIcon}><img src="./images/Real_time_Stats.svg" alt="" /></div></div>
                        ...
                        <div className={style.feature_card}>
                            <div className={style.feature_cardIconDiv}> <div className={style.feature_cardIcon}><img src="./images/Customer_Support.svg" alt="" /></div></div>
                        ...
                        <div className={style.feature_card}>
                            <div className={style.feature_cardIconDiv}> <div className={style.feature_cardIcon}><img src="./images/Tailored_Response.svg" alt="" /></div></div>
