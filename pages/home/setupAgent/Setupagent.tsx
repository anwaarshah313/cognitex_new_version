                ...
                <div className={style.setupagent_in}>
                    ...
                    <div className={style.setupagent_cardDiv}>
                        ...
                        <div className={style.setupagent_card}>
                            ...
                            <Image width={800} height={100} className={style.setupagent_cardImg} src="/images/flow_1.gif" alt="" />
                        </div>
                        ...
                        <div className={style.setupagent_card}>
                            ...
                            <Image width={800} height={100} className={style.setupagent_cardImg} src="/images/flow_2.gif" alt="" />
                        </div>
                        ...
                        <div className={style.setupagent_card}>
                            ...
                            <Image width={800} height={100} className={style.setupagent_cardImg} src="/images/flow_3.gif" alt="" />
                        </div>
                        ...
                        <div className={style.setupagent_card}>
                            ...
                            <Image width={800} height={100} className={style.setupagent_cardImg} src="/images/flow_4.gif" alt="" />
                        </div>
